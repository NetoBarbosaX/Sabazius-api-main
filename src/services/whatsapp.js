 ...
 */
Whatsapp.prototype.text = function (message) {
 ...
 * @returns {axios.Response}
 */
Whatsapp.prototype.image = function (image, caption = null) {
  return this.makeRequest({
    uri: "/send-image",
    body: {
      image,
 ...
 * @returns {axios.Response}
 */
Whatsapp.prototype.audio = function (audio) {
  return this.makeRequest({
    uri: "/send-audio",
    body: {
      audio,
 ...
 * @returns {axios.Response}
 */
Whatsapp.prototype.video = function (video) {
  return this.makeRequest({
    uri: "/send-video",
    body: {
      video,
 ...
 * @returns {axios.Response}
 */
Whatsapp.prototype.document = function (document, format, fileName = null) {
 ...
 * @returns {axios.Response}
 * @tutorial https://developer.z-api.io/message/send-message-link
 */
Whatsapp.prototype.link = function (body) {
  delete body.phone;
  return this.makeRequest({
    uri: "/send-link",
    body,
...
Whatsapp.prototype.formatPhone = function (phone) {
  phone = phone.replace(/\D/g, "");
  if (phone.length === 11) phone = "55" + phone;
  return phone;
};

Whatsapp.prototype.makeRequest = function (options) {
